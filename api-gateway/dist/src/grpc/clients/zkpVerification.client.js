...
// const PROTO_PATH = path.join(__dirname, "../../../../proto/zkpVerification.proto"); //this is for the production as per our dockerfile means for docker
const packageDef = protoLoader.loadSync(PROTO_PATH);
const zkpObj = grpc.loadPackageDefinition(packageDef);
