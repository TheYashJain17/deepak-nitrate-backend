    ...
    verifyClauseInclusion(call, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { a: A, b: B, c: C, inputSignals } = yield generateClauseInclusionProof({ agreementId, clauseSetHash, commitment }, WASM_PATH, ZKEY_PATH);
                ...
                const contract = yield getContractInstance(process.env.CLAUSE_INCLUSION_CONTRACT_ADDRESS, clauseInclusionAbi);
    ...
    bgExpiryCheck(call, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const contract = yield getContractInstance(process.env.BG_EXPIRY_CHECK_CONTRACT_ADDRESS, BGExpiryAbi);
    ...
    amountWithinRange(call, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log("The public signals we are getting is ", inputSignals);
                const contract = yield getContractInstance(process.env.AMOUNT_WITHIN_RANGE_CONTRACT_ADDRESS, AmountWithinRangeAbi);
